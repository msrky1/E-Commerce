        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong>Ürün </strong> Düzenle</h2>
                        ...
                        <div class="body">
                            ...
                            <div class="alert alert-success">
                                <strong>{{ Session::get('message') }}</strong> <a style="color: white"
                                    href="{{ route('admin.products') }}"> Ürünleri Görüntüle!</a>
                            </div>
                        @endif
                            <form id="form_validation" method="POST" wire:submit.prevent = "updateProduct">
                                @csrf
                                ...
                                <div class="form-group form-float">
                                    <input type="text" class="form-control" placeholder="Satış Fiyatı" name="sale_price"
                                ...
                                <div class="form-group form-float">
                                    <input type="text" class="form-control" placeholder="Miktarı" name="quantity" required
                                        wire:model="quantity" />
                                </div>
    
                                <div class="form-group form-float">
                                    <input type="text" class="form-control" placeholder="Stok Kodu" name="SKU" required
                                        wire:model="SKU" />
                                </div>
