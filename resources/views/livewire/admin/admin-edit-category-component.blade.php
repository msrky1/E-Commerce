                        ...
                        <form enctype="multipart/form-data" wire:submit.prevent="updateCategory">
                            ...
                            <div class="form-group form-float">
                                <input type="text" class="form-control" name="name" wire:model="name"
                                    wire:keyup="generateslug" /><br> <br>
                            </div>
                            <div class="form-group form-float">
                                <input type="text" class="form-control" name="slug" wire:model="slug" /><br>
                            </diV>
                            <br>
                            <button class="btn btn-raised btn-primary btn-round waves-effect" type="submit">Kategoriyi
                                Güncelle</button>
                        </form>
                    </div>
                </div>
